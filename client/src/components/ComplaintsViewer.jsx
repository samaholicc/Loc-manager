...
function ComplaintsViewer(props) {
  ...
  return (
    <section className="min-h-screen py-25 px-10 flex justify-center items-center bg-gray-100 ml-[1px] w-[calc(100%-1px)]">
      <div className="container bg-white rounded-xl shadow-lg overflow-hidden max-w-6xl w-full">
        <div className="p-6">
            ...
            comps.map((ele, index) => {
              return (
                ...
                ele.room_no && (
                  <div
                    key={index + 1}
                    className="border-2 my-3 p-5 flex justify-evenly rounded-lg shadow-sm"
                  >
                    <div className="mx-3">
                      <h1 className="text-center font-semibold text-gray-800 text-lg">
                        {ele.room_no}
                      </h1>
                      <h2 className="capitalize text-center text-gray-500 text-base">
                        Numéro de chambre
                      </h2>
                    </div>
                    <div className="mx-3">
                      ...
                      <h1 className="capitalize text-center text-gray-500 text-base">
                        Plaintes
                      </h1>
                    </div>
